...
st.write("Welcome to Oriel College! This is an AI system, developed by the Oriel JCR Fresher’s Rep, that's trained to answer any questions you may have about life at Oriel, from food and accommodation to Oxford traditions and everything in between.")
